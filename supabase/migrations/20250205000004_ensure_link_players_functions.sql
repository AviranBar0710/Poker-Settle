-- =====================================================
-- Migration: 20250205000004_ensure_link_players_functions
-- Purpose: Ensure search_profiles_by_email and link functions exist
--          (fixes "Could not find the function" error)
-- =====================================================

BEGIN;

-- Ensure search_profiles_by_email function exists
...
-- Ensure link_player_to_profile function exists
...
-- Ensure link_players_by_name_to_profile function exists
